...
/**
 * Simple Interface for MtrCuentaMayor para Carga Masiva.
 */
public interface MtrCuentaMayorRequireNewService extends JPACustomRequiredNewService<MtrCuentaMayor> {

...
/**
 * Simple Interface for MigCertificado para Carga Masiva.
 */
public interface MigCertificadoRequireNewService extends JPACustomRequiredNewService<MigCertificado> {

...
/**
 * Simple Interface for MtrEstrategiaFacturacion para Carga Masiva.
 */
public interface MtrEstrategiaFacturacionRequireNewService extends JPACustomRequiredNewService<MtrEstrategiaFacturacion> {

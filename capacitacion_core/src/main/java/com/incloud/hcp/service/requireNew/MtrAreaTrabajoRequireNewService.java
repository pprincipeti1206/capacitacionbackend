...
/**
 * Simple Interface for MtrAreaTrabajo para Carga Masiva.
 */
public interface MtrAreaTrabajoRequireNewService extends JPACustomRequiredNewService<MtrAreaTrabajo> {

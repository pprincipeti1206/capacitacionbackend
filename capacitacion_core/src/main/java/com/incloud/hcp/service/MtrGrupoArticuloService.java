...
/**
 * Simple Interface for MtrGrupoArticulo.
 */
public interface MtrGrupoArticuloService extends JPACustomService<MtrGrupoArticuloResponse, MtrGrupoArticulo, Integer> {

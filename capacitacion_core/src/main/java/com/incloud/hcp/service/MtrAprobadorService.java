 ...
 */
public interface MtrAprobadorService extends JPACustomService<MtrAprobadorResponse, MtrAprobador, Integer> {

    Long countByMtrAreaTrabajo(MtrAreaTrabajo mtrAreaTrabajo);

    GraphBean graphByMtrAreaTrabajo();

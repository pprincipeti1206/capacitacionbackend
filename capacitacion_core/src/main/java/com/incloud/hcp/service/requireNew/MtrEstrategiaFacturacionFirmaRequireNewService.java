...
/**
 * Simple Interface for MtrEstrategiaFacturacionFirma para Carga Masiva.
 */
public interface MtrEstrategiaFacturacionFirmaRequireNewService extends JPACustomRequiredNewService<MtrEstrategiaFacturacionFirma> {

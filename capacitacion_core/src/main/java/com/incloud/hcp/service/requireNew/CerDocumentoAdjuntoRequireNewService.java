...
/**
 * Simple Interface for CerDocumentoAdjunto para Carga Masiva.
 */
public interface CerDocumentoAdjuntoRequireNewService extends JPACustomRequiredNewService<CerDocumentoAdjunto> {

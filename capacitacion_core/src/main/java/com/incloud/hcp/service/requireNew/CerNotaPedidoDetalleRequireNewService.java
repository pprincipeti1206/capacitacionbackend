...
/**
 * Simple Interface for CerNotaPedidoDetalle para Carga Masiva.
 */
public interface CerNotaPedidoDetalleRequireNewService extends JPACustomRequiredNewService<CerNotaPedidoDetalle> {

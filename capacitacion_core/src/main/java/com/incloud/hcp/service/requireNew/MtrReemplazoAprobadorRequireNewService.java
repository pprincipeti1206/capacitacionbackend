...
/**
 * Simple Interface for MtrReemplazoAprobador para Carga Masiva.
 */
public interface MtrReemplazoAprobadorRequireNewService extends JPACustomRequiredNewService<MtrReemplazoAprobador> {

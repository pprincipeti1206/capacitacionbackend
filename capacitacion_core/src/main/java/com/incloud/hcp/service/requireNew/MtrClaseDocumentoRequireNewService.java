...
/**
 * Simple Interface for MtrClaseDocumento para Carga Masiva.
 */
public interface MtrClaseDocumentoRequireNewService extends JPACustomRequiredNewService<MtrClaseDocumento> {

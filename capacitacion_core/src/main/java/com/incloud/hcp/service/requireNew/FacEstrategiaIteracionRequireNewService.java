...
/**
 * Simple Interface for FacEstrategiaIteracion para Carga Masiva.
 */
public interface FacEstrategiaIteracionRequireNewService extends JPACustomRequiredNewService<FacEstrategiaIteracion> {

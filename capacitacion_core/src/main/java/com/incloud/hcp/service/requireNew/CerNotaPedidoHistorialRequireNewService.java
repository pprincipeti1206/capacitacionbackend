...
/**
 * Simple Interface for CerNotaPedidoHistorial para Carga Masiva.
 */
public interface CerNotaPedidoHistorialRequireNewService extends JPACustomRequiredNewService<CerNotaPedidoHistorial> {

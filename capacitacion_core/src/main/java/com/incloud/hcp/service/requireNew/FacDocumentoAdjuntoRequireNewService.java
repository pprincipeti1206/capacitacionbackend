...
/**
 * Simple Interface for FacDocumentoAdjunto para Carga Masiva.
 */
public interface FacDocumentoAdjuntoRequireNewService extends JPACustomRequiredNewService<FacDocumentoAdjunto> {

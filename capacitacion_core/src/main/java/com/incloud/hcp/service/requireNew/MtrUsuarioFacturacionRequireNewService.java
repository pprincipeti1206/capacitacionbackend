...
/**
 * Simple Interface for MtrUsuarioFacturacion para Carga Masiva.
 */
public interface MtrUsuarioFacturacionRequireNewService extends JPACustomRequiredNewService<MtrUsuarioFacturacion> {

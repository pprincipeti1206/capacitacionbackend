...
/**
 * Simple Interface for MtrTipoGerencia para Carga Masiva.
 */
public interface MtrTipoGerenciaRequireNewService extends JPACustomRequiredNewService<MtrTipoGerencia> {

...
/**
 * Simple Interface for MtrTipoContrato para Carga Masiva.
 */
public interface MtrTipoContratoRequireNewService extends JPACustomRequiredNewService<MtrTipoContrato> {

...
@Component
public class RegistroSolicitudProveedorRechazoNotificacion extends NotificarMail {

    private final Logger logger = LoggerFactory.getLogger(this.getClass());

    private final String TEMPLATE1 = "com/incloud/hcp/templates/TemplateRegistroSolicitudRechazoNotificacion.html";
    ...
    private final String ASUNTO = "IProvider - Gestiòn Proveedor Rechazo";
    ...
    public void enviar(
        ...
        logger.error("RegistroSolicitudProveedorRechazoNotificacion :  " + pre);
        logger.error("RegistroSolicitudProveedorRechazoNotificacion_concepto :  " + concepto);

...
/**
 * Simple Interface for MigCertificadoAdjunto para Carga Masiva.
 */
public interface MigCertificadoAdjuntoRequireNewService extends JPACustomRequiredNewService<MigCertificadoAdjunto> {

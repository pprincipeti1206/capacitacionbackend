...
/**
 * Simple Interface for MtrBienServicio para Carga Masiva.
 */
public interface MtrBienServicioRequireNewService extends JPACustomRequiredNewService<MtrBienServicio> {

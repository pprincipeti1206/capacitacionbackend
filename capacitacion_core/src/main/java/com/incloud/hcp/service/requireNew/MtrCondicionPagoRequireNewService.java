...
/**
 * Simple Interface for MtrCondicionPago para Carga Masiva.
 */
public interface MtrCondicionPagoRequireNewService extends JPACustomRequiredNewService<MtrCondicionPago> {

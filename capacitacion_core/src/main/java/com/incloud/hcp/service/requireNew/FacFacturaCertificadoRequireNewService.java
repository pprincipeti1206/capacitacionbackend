...
/**
 * Simple Interface for FacFacturaCertificado para Carga Masiva.
 */
public interface FacFacturaCertificadoRequireNewService extends JPACustomRequiredNewService<FacFacturaCertificado> {

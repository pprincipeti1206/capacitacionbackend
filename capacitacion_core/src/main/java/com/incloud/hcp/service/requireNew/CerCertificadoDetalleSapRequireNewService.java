...
/**
 * Simple Interface for CerCertificadoDetalleSap para Carga Masiva.
 */
public interface CerCertificadoDetalleSapRequireNewService extends JPACustomRequiredNewService<CerCertificadoDetalleSap> {

...
/**
 * Simple Interface for MtrTipoInformacionNoticia para Carga Masiva.
 */
public interface MtrTipoInformacionNoticiaRequireNewService extends JPACustomRequiredNewService<MtrTipoInformacionNoticia> {

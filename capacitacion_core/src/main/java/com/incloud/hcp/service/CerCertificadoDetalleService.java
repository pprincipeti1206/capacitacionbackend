 ...
 */
public interface CerCertificadoDetalleService extends JPACustomService<CerCertificadoDetalleResponse, CerCertificadoDetalle, Integer> {

    Long countByMtrCuentaImputacion(MtrCuentaImputacion mtrCuentaImputacion);

    GraphBean graphByMtrCuentaImputacion();

    Long countByCerNotaPedidoDetalle(CerNotaPedidoDetalle cerNotaPedidoDetalle);

    GraphBean graphByCerNotaPedidoDetalle();

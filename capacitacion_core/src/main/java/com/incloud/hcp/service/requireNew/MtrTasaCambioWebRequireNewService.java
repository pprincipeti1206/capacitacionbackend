...
/**
 * Simple Interface for MtrTasaCambioWeb para Carga Masiva.
 */
public interface MtrTasaCambioWebRequireNewService extends JPACustomRequiredNewService<MtrTasaCambioWeb> {

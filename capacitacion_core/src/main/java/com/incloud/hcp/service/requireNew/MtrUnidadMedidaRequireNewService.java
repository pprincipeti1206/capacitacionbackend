...
/**
 * Simple Interface for MtrUnidadMedida para Carga Masiva.
 */
public interface MtrUnidadMedidaRequireNewService extends JPACustomRequiredNewService<MtrUnidadMedida> {

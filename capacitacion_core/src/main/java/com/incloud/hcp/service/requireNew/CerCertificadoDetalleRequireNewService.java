...
/**
 * Simple Interface for CerCertificadoDetalle para Carga Masiva.
 */
public interface CerCertificadoDetalleRequireNewService extends JPACustomRequiredNewService<CerCertificadoDetalle> {

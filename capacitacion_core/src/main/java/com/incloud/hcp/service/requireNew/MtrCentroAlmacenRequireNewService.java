...
/**
 * Simple Interface for MtrCentroAlmacen para Carga Masiva.
 */
public interface MtrCentroAlmacenRequireNewService extends JPACustomRequiredNewService<MtrCentroAlmacen> {

...
/**
 * Simple Interface for MtrTipoImputacion para Carga Masiva.
 */
public interface MtrTipoImputacionRequireNewService extends JPACustomRequiredNewService<MtrTipoImputacion> {

...
/**
 * Simple Interface for FacEstrategiaFirma para Carga Masiva.
 */
public interface FacEstrategiaFirmaRequireNewService extends JPACustomRequiredNewService<FacEstrategiaFirma> {

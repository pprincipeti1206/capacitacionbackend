...
/**
 * Simple Interface for MtrCuentaImputacion para Carga Masiva.
 */
public interface MtrCuentaImputacionRequireNewService extends JPACustomRequiredNewService<MtrCuentaImputacion> {

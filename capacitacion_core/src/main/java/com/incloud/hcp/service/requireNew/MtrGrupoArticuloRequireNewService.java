...
/**
 * Simple Interface for MtrGrupoArticulo para Carga Masiva.
 */
public interface MtrGrupoArticuloRequireNewService extends JPACustomRequiredNewService<MtrGrupoArticulo> {

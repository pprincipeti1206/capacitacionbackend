...
/**
 * Simple Interface for MigCertificadoDetalle para Carga Masiva.
 */
public interface MigCertificadoDetalleRequireNewService extends JPACustomRequiredNewService<MigCertificadoDetalle> {

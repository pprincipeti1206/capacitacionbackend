...
public abstract class MtrSociedadRest extends JPACustomRest<MtrSociedadResponse, MtrSociedad, Integer> {
    ...
    public ResponseEntity<MtrSociedad> getByDescripcion(@PathVariable String descripcion) throws URISyntaxException {
        log.debug(this.NOMBRE_CLASE + " - Ingresando getByDescripcion: " + descripcion);
        try {
            return Optional.ofNullable(this.mtrSociedadDeltaRepository.getByDescripcion(descripcion)).map(bean -> new ResponseEntity<>(bean, HttpStatus.OK))

...
public abstract class MtrTipoInformacionNoticiaRest extends JPACustomRest<MtrTipoInformacionNoticiaResponse, MtrTipoInformacionNoticia, Integer> {
    ...
    public ResponseEntity<MtrTipoInformacionNoticia> getByDescripcion(@PathVariable String descripcion) throws URISyntaxException {
        log.debug(this.NOMBRE_CLASE + " - Ingresando getByDescripcion: " + descripcion);
        try {
            return Optional.ofNullable(this.mtrTipoInformacionNoticiaDeltaRepository.getByDescripcion(descripcion))

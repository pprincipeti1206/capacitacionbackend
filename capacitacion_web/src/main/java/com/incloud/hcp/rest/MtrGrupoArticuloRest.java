...
public abstract class MtrGrupoArticuloRest extends JPACustomRest<MtrGrupoArticuloResponse, MtrGrupoArticulo, Integer> {
    ...
    public ResponseEntity<MtrGrupoArticulo> getByCodigoSap(@PathVariable String codigoSap) throws URISyntaxException {
        log.debug(this.NOMBRE_CLASE + " - Ingresando getByCodigoSap: " + codigoSap);
        try {
            return Optional.ofNullable(this.mtrGrupoArticuloDeltaRepository.getByCodigoSap(codigoSap)).map(bean -> new ResponseEntity<>(bean, HttpStatus.OK))
    ...
    public ResponseEntity<MtrGrupoArticulo> getByDescripcion(@PathVariable String descripcion) throws URISyntaxException {
        log.debug(this.NOMBRE_CLASE + " - Ingresando getByDescripcion: " + descripcion);
        try {
            return Optional.ofNullable(this.mtrGrupoArticuloDeltaRepository.getByDescripcion(descripcion))

...
public abstract class CerCertificadoRest extends JPACustomRest<CerCertificadoResponse, CerCertificado, Integer> {
    ...
    */
    ...
    public ResponseEntity<Long> countByCerNotaPedido(@RequestBody @Valid CerNotaPedido cerNotaPedido, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByCerNotaPedido(cerNotaPedido)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByCerNotaPedido() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByCerNotaPedido()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrProveedor(@RequestBody @Valid MtrProveedor mtrProveedor, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByMtrProveedor(mtrProveedor)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrProveedor() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByMtrProveedor()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrSociedad(@RequestBody @Valid MtrSociedad mtrSociedad, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByMtrSociedad(mtrSociedad)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrSociedad() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByMtrSociedad()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrMoneda(@RequestBody @Valid MtrMoneda mtrMoneda, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByMtrMoneda(mtrMoneda)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrMoneda() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByMtrMoneda()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrClaseDocumento(@RequestBody @Valid MtrClaseDocumento mtrClaseDocumento, BindingResult bindingResult)
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByMtrClaseDocumento(mtrClaseDocumento))
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrClaseDocumento() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByMtrClaseDocumento()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrEstado(@RequestBody @Valid MtrEstado mtrEstado, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.countByMtrEstado(mtrEstado)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrEstado() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerCertificadoDeltaService.graphByMtrEstado()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);

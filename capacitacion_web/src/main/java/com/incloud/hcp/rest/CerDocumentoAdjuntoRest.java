...
public abstract class CerDocumentoAdjuntoRest extends JPACustomRest<CerDocumentoAdjuntoResponse, CerDocumentoAdjunto, Integer> {
    ...
    */
    ...
    public ResponseEntity<Long> countByCerCertificado(@RequestBody @Valid CerCertificado cerCertificado, BindingResult bindingResult)
        ...
        try {
            return Optional.ofNullable(this.cerDocumentoAdjuntoDeltaService.countByCerCertificado(cerCertificado))
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByCerCertificado() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.cerDocumentoAdjuntoDeltaService.graphByCerCertificado()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))

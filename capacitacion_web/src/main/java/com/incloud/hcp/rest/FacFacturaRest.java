...
public abstract class FacFacturaRest extends JPACustomRest<FacFacturaResponse, FacFactura, Integer> {
    ...
    */
    ...
    public ResponseEntity<Long> countByMtrSociedad(@RequestBody @Valid MtrSociedad mtrSociedad, BindingResult bindingResult) throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.countByMtrSociedad(mtrSociedad)).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);
    ...
    */
    ...
    public ResponseEntity<GraphBean> graphByMtrSociedad() throws URISyntaxException {
        ...
        try {
            return Optional.ofNullable(this.facFacturaDeltaService.graphByMtrSociedad()).map(l -> new ResponseEntity<>(l, HttpStatus.OK))
                    .orElse(new ResponseEntity<>(HttpStatus.NO_CONTENT));
        } catch (Exception e) {
            if (this.devuelveRuntimeException) {
                throw new RuntimeException(e);

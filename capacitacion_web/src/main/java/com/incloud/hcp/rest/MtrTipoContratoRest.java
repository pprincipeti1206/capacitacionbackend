...
public abstract class MtrTipoContratoRest extends JPACustomRest<MtrTipoContratoResponse, MtrTipoContrato, Integer> {
    ...
    public ResponseEntity<MtrTipoContrato> getByDescripcion(@PathVariable String descripcion) throws URISyntaxException {
        log.debug(this.NOMBRE_CLASE + " - Ingresando getByDescripcion: " + descripcion);
        try {
            return Optional.ofNullable(this.mtrTipoContratoDeltaRepository.getByDescripcion(descripcion)).map(bean -> new ResponseEntity<>(bean, HttpStatus.OK))
